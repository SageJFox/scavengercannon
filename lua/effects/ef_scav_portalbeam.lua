...
function EFFECT:Init(data)
	...
	ParticleEffectAttach(PORTAL and "portal_1_projectile_stream" or "Rocket_Smoke", PATTACH_ABSORIGIN_FOLLOW, self, 0)
...
function EFFECT:Think()
	...
	if tr.Hit then
		...
		--ParticleEffect("scav_exp_plasma", tr.HitPos, angle_zero, Entity(0))
		return false
	end
