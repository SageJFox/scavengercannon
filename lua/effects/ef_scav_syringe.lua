...
function EFFECT:Init(data)
	...
	self:SetPos(self.Owner:GetShootPos() + (self.Owner:GetAimVector():Angle():Right() * 2 - self.Owner:GetAimVector():Angle():Up() * 2))
	self.time = UnPredictedCurTime() + 0.4
	self:SetModel(data:GetColor() == SCAV_SYRINGE_DEFAULT and "models/weapons/w_models/w_syringe_proj.mdl" or "models/weapons/c_models/c_leechgun/c_leech_proj.mdl")
...
effects.Register(EFFECT, "ef_scav_syringe", true)