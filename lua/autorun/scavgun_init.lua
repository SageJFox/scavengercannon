...
--Identify enums
	--Battery
	SCAV_BATTERY_DEFAULT	= 0
	SCAV_BATTERY_BATTALION	= 1
	SCAV_BATTERY_RESISTANCE	= 2
	SCAV_BATTERY_DODSHELMET	= 3
	SCAV_BATTERY_BMSHELMET	= 4
	SCAV_BATTERY_VEST		= 5
	SCAV_BATTERY_HEV		= 6
	--Buzzsaw
	...
	SCAV_CRIT_DEFAULT	= 0
	SCAV_CRIT_DRINK		= 1
	SCAV_CRIT_STEROIDS	= 2
	--Disease Shot
	SCAV_DISEASE_DEFAULT	= 0
	SCAV_DISEASE_JARATE		= 1
	--Flares
	SCAV_FLARE_HL2		= 0
	SCAV_FLARE_TF2		= 1
	SCAV_FLARE_ASW		= 2
	...
	SCAV_HORNET_BMS		= 2
	--Invulnerability
	SCAV_INVULN_DEFAULT		= 0
	SCAV_INVULN_MANN_UBER	= 1
	--Magnusson Device
	SCAV_MAGNUSSON_DEFAULT	= 0
	SCAV_MAGNUSSON_PUMPKIN	= 1
	--Medkit
	SCAV_MEDKIT_HL2		= 0
	SCAV_MEDKIT_VIAL	= 1
	SCAV_MEDKIT_TF2S	= 2
	...
	--Minigun
	SCAV_MINIGUN_DEFAULT 	= 0
	SCAV_MINIGUN_TF2		= 1
	--Plasma Gun
	SCAV_PLASMA_DEFAULT	= 0
	SCAV_PLASMA_XEN		= 1
	--Physics Shotgun
	SCAV_PHYSSHOT_TOILET_HL2	= 0
	SCAV_PHYSSHOT_TOILET_L4D	= 1
	SCAV_PHYSSHOT_MELON			= 2
	SCAV_PHYSSHOT_VENT			= 3
	SCAV_PHYSSHOT_SINK			= 4
	SCAV_PHYSSHOT_BARREL		= 5
	SCAV_PHYSSHOT_CLAYPOT		= 6
	SCAV_PHYSSHOT_CLAYPOT3		= 7
	SCAV_PHYSSHOT_PROJECTOR		= 8
	SCAV_PHYSSHOT_PALLET_HL2	= 9
	SCAV_PHYSSHOT_PALLET_CSS	= 10
	SCAV_PHYSSHOT_PALLET_L4D	= 11
	SCAV_PHYSSHOT_BRICKS		= 12
	SCAV_PHYSSHOT_BARRICADE		= 13
	SCAV_PHYSSHOT_DEFAULT		= SCAV_PHYSSHOT_TOILET_HL2
	--Physics Super Shotgun
	SCAV_PHYSSHOTSUPER_BUST			= 0
	SCAV_PHYSSHOTSUPER_ANTLIONPLUG	= 1
	SCAV_PHYSSHOTSUPER_OFFICEPLANT	= 2
	SCAV_PHYSSHOTSUPER_FLOWERBARREL	= 3
	SCAV_PHYSSHOTSUPER_FOUNTAINBOWL	= 4
	SCAV_PHYSSHOTSUPER_SKYLIGHT		= 5
	SCAV_PHYSSHOTSUPER_ATLAS		= 6
	SCAV_PHYSSHOTSUPER_COLUMN		= 7
	SCAV_PHYSSHOTSUPER_DEFECTIVE	= 8
	SCAV_PHYSSHOTSUPER_BARRICADE	= 9
	SCAV_PHYSSHOTSUPER_BOAT			= 10
	SCAV_PHYSSHOTSUPER_PARTITION	= 11
	SCAV_PHYSSHOTSUPER_DEFAULT		= SCAV_PHYSSHOTSUPER_BOAT
	--Pistol
	SCAV_PISTOL_HL2		= 0
	SCAV_PISTOL_TF2		= 1
	SCAV_PISTOL_HL		= 2
	--Proximity Mine
	SCAV_PROXMINE_STICKY = 0
	SCAV_PROXMINE_NONSTICKY = 1
	--Revolver
	SCAV_REVOLVER_DEFAULT		= 0
	SCAV_REVOLVER_LEVER			= 1
	SCAV_REVOLVER_TF2			= 2
	SCAV_REVOLVER_AMBY			= 3
	SCAV_REVOLVER_ENFORCER		= 4
	SCAV_REVOLVER_BIGKILL		= 5
	SCAV_REVOLVER_LETRANGER		= 6
	SCAV_REVOLVER_DIAMONDBACK	= 7
	SCAV_REVOLVER_HL1			= 8
	--Rocket
	SCAV_ROCKET_DEFAULT		= 0
	SCAV_ROCKET_TF2			= 1
	SCAV_ROCKET_SENTRY		= 2
	SCAV_ROCKET_AIRSTRIKE	= 3
	SCAV_ROCKET_DODS		= 4
	SCAV_ROCKET_HL1			= 5
	--Sandwich?
	...
	SCAV_SG_RESERVE		= 8
	SCAV_SG_FAMBIZ		= 9
	SCAV_SG_SHORTSTOP	= 10
	SCAV_SG_BFB			= 11
	SCAV_SG_BACKSCATTER	= 12
	SCAV_SG_ASW			= 13
	SCAV_SG_VINDICATOR	= 14
	SCAV_SG_BMS			= 15
	--SMG
	SCAV_SMG_HL2		= 0
	SCAV_SMG_ALYX		= 1
	...
	SCAV_SMG_HL			= 4
	--SMG1 Grenade
	SCAV_SMGNADE_DEFAULT	= 0
	SCAV_SMGNADE_GARAND		= 1
	SCAV_SMGNADE_KAR98		= 2
	SCAV_SMGNADE_L4D2		= 3
	SCAV_SMGNADE_HL1		= 4
	SCAV_SMGNADE_BMS		= 5
	--Sniper Rifle
	...
	SCAV_STIM_NEEDLE		= 2
	SCAV_STIM_WHIP			= 3
	SCAV_STIM_MANN_AGILITY	= 4
	SCAV_STIM_MANN_HASTE	= 5
	SCAV_STIM_BOOT			= 6
	--Supersonic Shockwave
	SCAV_SONIC_DEFAULT	= 0
	SCAV_SONIC_BEANS	= 1
	SCAV_SONIC_BELL_CSS	= 2
	SCAV_SONIC_BELL_DOD	= 3
	SCAV_SONIC_BELL_FOF	= 4
	--Syringe Gun
	...
	SCAV_TELE_PORTAL	= 2
	SCAV_TELE_TF2		= 3
	--Turret (Auto-target Rifle)
	SCAV_TURRET_HL2		= 0
	SCAV_TURRET_TF2LV1	= 1
	SCAV_TURRET_TF2LV2	= 2
	SCAV_TURRET_PORTAL	= 3
	SCAV_TURRET_HL		= 4
	SCAV_TURRET_ASW		= 5
	--Vortigaunt
	SCAV_VORT_HL2	= 0
...
ScavDropUsefulRagdoll_npcs = {
	...
	["npc_antlion_worker"] = true, --acid spit --only ragdolls in water
...
game.AddParticles("particles/scav_particles95.pcf")
...
function ScavData.RegisterFiremode(tab, model, count)
	local model = ScavData.FormatModelname(model)
	ScavData.models[model] = tab
