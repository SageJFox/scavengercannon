...
SKIN.Damage[DMG_ENERGYBEAM] = dmgpaint(dmggridspace * 5, dmggridspace, Color(51, 210, 250))
...
SKIN.Damage[DMG_NERVEGAS] = dmgpaint(dmggridspace * 5, dmggridspace * 2, Color(175, 173, 43))

SKIN.Damage[DMG_POISON] = dmgpaint(0, dmggridspace * 3, Color(85, 224, 30))
SKIN.Damage[DMG_PARALYZE] = SKIN.Damage[DMG_POISON]
...
SKIN.Damage[DMG_ACID] = dmgpaint(dmggridspace * 3, dmggridspace * 3, Color(166, 255, 0))
SKIN.Damage[DMG_SLOWBURN] = SKIN.Damage[DMG_BURN]
SKIN.Damage[DMG_REMOVENORAGDOLL] = SKIN.Damage[DMG_GENERIC]


SKIN.Damage[DMG_PHYSGUN] = dmgpaint(0, dmggridspace * 4, Color(255, 140, 64))
SKIN.Damage[DMG_PLASMA] = dmgpaint(dmggridspace * 4, 0, Color(16, 128, 255)) --dmgpaint(dmggridspace, dmggridspace * 4)
SKIN.Damage[DMG_AIRBOAT] = dmgpaint(dmggridspace * 2, 0, Color(28, 192, 241))
SKIN.Damage[DMG_DISSOLVE] = dmgpaint(dmggridspace * 3, dmggridspace * 4, Color(52, 243, 250))
