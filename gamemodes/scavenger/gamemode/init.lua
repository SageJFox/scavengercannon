...
--This function is called when the gamemode reads the game vars from a GLoader file.
--This is used to determine how each gamevar is used, like networking it for example.
function GM:GameVar(key, value)
